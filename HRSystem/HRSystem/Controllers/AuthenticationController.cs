...
using Hr.Application.SeedData;
using Hr.Domain.Entities;
using HRSystem.Application.DTOs.Authentication;
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(RegisterUserDto userDto)
        {
            if (ModelState.IsValid)
            {
                ...
                if (userDto.Role != null && roleManager.RoleExistsAsync(userDto.Role).Result)
                {
            ...
            return StatusCode(StatusCodes.Status400BadRequest, new { message = "Invalid model" });
        }
