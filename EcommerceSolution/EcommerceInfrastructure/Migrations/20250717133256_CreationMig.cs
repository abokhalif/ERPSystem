    ...
    public partial class CreationMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Electronic devices and accessories", true, false, "Electronics" },
                    { 2, "Books and magazines", true, false, "Books" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Description", "DiscountPercentage", "ImageUrl", "IsAvailable", "IsDeleted", "Name", "Price", "StockQuantity" },
                values: new object[,]
                {
                    { 1, 1, "Latest model smartphone with advanced features.", 10, "https://example.com/images/smartphone.jpg", true, false, "Smartphone", 699.99m, 50 },
                    { 2, 1, "High-performance laptop suitable for all your needs.", 15, "https://example.com/images/laptop.jpg", true, false, "Laptop", 999.99m, 30 },
                    { 3, 2, "A thrilling science fiction novel set in the future.", 5, "https://example.com/images/scifi-novel.jpg", true, false, "Science Fiction Novel", 19.99m, 100 }
                });
